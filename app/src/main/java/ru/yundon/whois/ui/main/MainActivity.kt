...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickButton() = with(binding){
        ...
        buttonSearch.setOnClickListener {
            ...
            progresBarLoading.visibility = View.VISIBLE
    ...
    private fun setupRecyclerView(list: List<WhoisDataMain>) {
        binding.domainUrlRecacler.layoutManager = LinearLayoutManager(this)
        ...
        binding.domainUrlRecacler.adapter = whoisAdapter
    }
